...
export const projects: Project[] = [
  {
    ...
    contributions: [
      ...
      {
        title: "앱-웹 브릿지 구축 — Promise 기반 appBridge, 안드로이드 백버튼 연동은 RN까지 직접 구현",
        details: [
      ...
      {
        title: "성능 실측 개선 — First Load JS gzip −27.6%, TBT −54% · 목 분기 5,164줄 MSW 일원화",
        details: [
  ...
  },
  {
    ...
    team: "프론트 다수 + 백엔드 협업",
    oneLiner:
      "브랜드 운영사가 회원·NFT·포인트·커뮤니티·푸시 캠페인을 관리하는 B2B 어드민 웹에서 API 통신·캐시·폼의 공통 구조를 잡아 전체 화면에 적용했고, 이후 추가된 도메인들도 팀원들이 같은 구조로 개발하고 있습니다.",
    summary:
  ...
  },
  {
    ...
    contributions: [
      ...
      {
        title: "파트너사용 B2B 관리자 웹 개발 — 같은 도메인을 이후 React 비즈센터로 전환",
        details: [
